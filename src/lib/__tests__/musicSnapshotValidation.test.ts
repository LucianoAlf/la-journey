...
const notationWithNotehead = `<svg><rect x="20" y="10" width="300" height="1"></rect><text>\uE0A4</text></svg>`
const notationWithTimeSignatureButNoNotes = `<svg><rect x="20" y="10" width="300" height="1"></rect><text>\uE084</text><text>\uE082</text></svg>`
...
test('rejects staff-only AlphaTab snapshots', () => {
  ...
  assert(!isUsableMusicSnapshotHtml(notationWithTimeSignatureButNoNotes, 'notation'), 'time signature glyphs without notes should be rejected')
})
