  ...
  return (
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-300">
      ...
      <Tabs defaultValue="acordes" className="mb-6" onValueChange={setActiveTab}>
        <TabsList>
          <TabsTrigger value="acordes">Biblioteca de Acordes</TabsTrigger>
              ...
              <div className="grid grid-cols-4 gap-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <Select defaultValue="todos"><SelectTrigger><SelectValue /></SelectTrigger>
                    <SelectContent>
                      <SelectItem value="todos">Todos</SelectItem>
                      <SelectItem value="1">1 - Fácil</SelectItem><SelectItem value="2">2</SelectItem>
        ...
        <TabsContent value="escalas">
          <div className="card">
            <Table>
              ...
              <TableBody>
                <TableRow>
                  <TableCell className="font-bold">Dó Maior</TableCell>
                  <TableCell className="font-mono text-xs">C D E F G A B</TableCell>
                  <TableCell className="text-xs">T T ST T T T ST</TableCell>
                  <TableCell>Universal</TableCell>
                  <TableCell><Badge variant="grow">Grow</Badge></TableCell>
                  <TableCell><span className="text-[11px] text-text3">VexFlow Preview</span></TableCell>
                </TableRow>
              </TableBody>
            </Table>
          </div>
        ...
        <TabsContent value="imagens">
          <div>
            <div className="flex items-center gap-2.5 py-3.5 px-5 bg-foundation-soft border border-[rgba(99,102,241,0.2)] rounded-[var(--radius)] mb-4">
              ...
              <Button size="sm">✨ Gerar Imagem</Button>
            </div>
